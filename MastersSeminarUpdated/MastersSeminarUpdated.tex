...
\end{frame}
    ...
    \begin{frame}{Results}{Hardness Factor of the MC40 Cyclotron}
        ...
        \end{figure}
    \vspace{-0.3cm}
    From this, a value of \bm{$\kappa _{MC40} = 2.198 \pm 0.084$} for \textbf{25 MeV protons} was inferred.
    \end{frame}
    ...
    \begin{frame}{Results}{Hardness Factor of the IRRAD Proton Facility}
        ...
        \end{figure}
    Using the same method as for the MC40 Cyclotron, a value of \bm{$\kappa _{IRRAD} = 0.622 \pm 0.019$} for \textbf{24 GeV protons} was inferred.
    \end{frame}
    ...
    \begin{frame}{Results}{Hardness Factor of the IRRAD Proton Facility - Comparison with I. Mateu's Data}
        ...
        \end{figure}
    \vspace{-0.5cm}
    Analysis of I. Mateu's data yields a value of \bm{$\kappa _{Mateu} = 0.616 \pm 0.017$}, which is in agreement with his own analysis (0.632) and our result.
    \end{frame}
    ...
    \begin{frame}{Hardness Factor of the KIT Irradiations Facility}
        ...
        \end{figure}
    The highest fluence point was ignored to omit the non-linearity region ($\sim 10^{13}$ n\textsubscript{eq}/cm\textsuperscript{2} \textsuperscript{\cite{Ravotti}}). This gave a value of \bm{$\kappa _{KIT} = 2.199 \pm 0.282$} for \textbf{24 MeV protons}.    
    \end{frame}
